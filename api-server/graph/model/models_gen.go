...
type OAuth2Client struct {
	...
	// Specify a time duration in milliseconds, seconds, minutes, hours. For example, 1h, 1m, 1s, 1ms.
	AuthorizationCodeGrantRefreshTokenLifespan *string `json:"authorization_code_grant_refresh_token_lifespan"`
	// OpenID Connect Back-Channel Logout Session Required  Boolean value specifying whether the RP requires that a sid (session ID) Claim be included in the Logout Token to identify the RP session with the OP when the backchannel_logout_uri is used. If omitted, the default value is false.
	BackChannelLogoutSessionRequired *bool `json:"back_channel_logout_session_required"`
	...
	TokenEndpointAuthSigningAlgorithm *string `json:"token_endpoint_auth_signing_algorithm"`
	...
	UserinfoSignedResponseAlgorithm *string `json:"userinfo_signed_response_algorithm"`
	// The organization that owns this OAuth2 Client.
	Organization *Organization `json:"organization"`
	// The users and groups that are allowed to login with this OAuth2 Client.
	LoginBindings *LoginBindings `json:"login_bindings"`
}
...
type ObservabilityTenantViewers struct {
	...
	Oauth2Clients []*OAuth2Client `json:"oauth2_clients"`
}
